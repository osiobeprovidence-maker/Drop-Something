          ...
          <div className="space-y-4">
            ...
            >
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17.073 10.117c-.033-2.337 1.906-3.46 1.983-3.509-1.083-1.583-2.768-1.802-3.368-1.826-1.432-.146-2.793.843-3.518.843s-1.874-.822-3.083-.801c-1.583.023-3.048.922-3.861 2.337-1.644 2.852-.42 7.07 1.173 9.37.781 1.125 1.706 2.392 2.916 2.347 1.166-.048 1.604-.755 3.016-.755s1.804.755 3.038.732c1.256-.023 2.059-1.147 2.822-2.272.894-1.306 1.256-2.571 1.278-2.637-.027-.011-2.454-.942-2.484-3.73zM14.931 4.354c.642-.779 1.077-1.862.959-2.937-.923.037-2.037.618-2.699 1.397-.594.693-1.114 1.782-.975 2.84.996.077 2.032-.516 2.715-1.3z" />
              </svg>
              Continue with Apple
            </button>
          </div>
