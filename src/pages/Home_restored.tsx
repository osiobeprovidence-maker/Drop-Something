          ...
          <div className="relative">
            ...
            >
              <div className="flex flex-col gap-2">
                <div className="font-black text-sm text-gray-900">Ada <span className="text-gray-400 font-bold">dropped</span> Γéª1000</div>
                <p className="text-xs text-gray-500 font-bold italic leading-relaxed">"Your tutorials helped me so much."</p>
                <div className="flex gap-1 mt-1">
                  <span className="text-xs">Γ£¿</span>
                  <span className="text-xs">≡ƒÖî</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex flex-col gap-2">
                <div className="font-black text-sm text-gray-900">Riderezzy <span className="text-gray-400 font-bold">dropped</span> Γéª2000</div>
                <p className="text-xs text-gray-500 font-bold italic leading-relaxed">"Big fan of your work."</p>
                <div className="flex gap-1 mt-1">
                  <span className="text-xs">≡ƒÜÇ</span>
                  <span className="text-xs">≡ƒÆÄ</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-gray-400 font-bold">Keep creating ≡ƒöÑ</div>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-12">
              <div className="grid sm:grid-cols-2 gap-6 items-start">
                ...
                <div className="space-y-6">
                  {[
                    { title: "Supporter Tier", price: "Γéª1,000", benefits: ["Support my work monthly", "Early access to new content", "Exclusive supporter updates"] },
                    { title: "Inner Circle", price: "Γéª3,000", benefits: ["Monthly supporter badge", "Behind-the-scenes updates", "Exclusive posts and messages"] },
                    { title: "Super Supporter", price: "Γéª5,000", benefits: ["Priority supporter recognition", "Special shoutouts", "Access to exclusive content"] }
                  ].map((tier, i) => (
                    <motion.div 
                      key={i}
                ...
                <div className="relative pt-12 sm:pt-16">
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between text-xs font-black">
                        <span className="text-gray-900">Γéª120,000 <span className="text-gray-400 font-bold">raised</span></span>
                        <span className="text-gray-400">Γéª200,000 <span className="text-gray-400 font-bold">goal</span></span>
                      </div>
                  ...
                  >
                    <div className="font-black text-[10px] text-gray-900 leading-none mb-1 flex items-center gap-1">
                      Ada <span className="text-primary">dropped</span> Γéª2k
                    </div>
                  ...
                  >
                    <div className="font-black text-[10px] text-gray-900 leading-none mb-1 flex items-center gap-1">
                      Tunde <span className="text-secondary">dropped</span> Γéª1k
                    </div>
                    <p className="text-[10px] text-gray-500 font-bold leading-tight">"Keep creating ≡ƒöÑ"</p>
                  </motion.div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            {[
              ...
              { 
                ...
                a: "Supporters can choose an amount such as Γéª500, Γéª1000, or Γéª2000, leave a message, and complete the payment in just a few taps." 
              },
              { 
                q: "Who can use DropSomething?", 
                a: "Anyone who creates value online can use DropSomething ΓÇö creators, developers, writers, designers, podcasters, and online communities." 
              },
              { 
